...
export default function ActivitiesPage() {
  ...
  const handleAddActivity = async (values: ActivityFormValues, createAnother: boolean) => {
    try {
      // Simulate API call
      ...
      <div className="flex flex-col h-full">
        <div className="flex justify-between items-start p-6 border-b">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground">Track and manage your tasks and events</p>
          </div>
